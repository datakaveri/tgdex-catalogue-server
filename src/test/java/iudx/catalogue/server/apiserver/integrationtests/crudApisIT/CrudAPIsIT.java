...
public class CrudAPIsIT {
    ...
    void createAdexAppsItem() {
        ...
        JsonObject jsonPayload = new JsonObject()
            ...
            .put("shortDescription", "An AI-based application that detects diseases in crops by analyzing images of leaves")
            .put("uploadedBy", "cdpg_admin@datakaveri.org")
            .put("fileFormat", "csv")
            .put("accessPolicy", "Public")
            .put("organizationType", "Private")
            .put("department", "Agriculture and Co-operation")
            .put("canBeUsedFor", new JsonObject()
                .put("Early Risk Stratification", "Helps predict diseases early in crops")
                .put("Field-Level Prioritisation", "Identifies fields needing urgent attention"))
            .put("dataInputsAndAiTechniques", new JsonObject()
                .put("Input Data Banks", new JsonArray().add("Leaf Image Dataset").add("Field Survey Data"))
                .put("Expected Output", new JsonArray().add("Disease Category").add("Confidence Score"))
                .put("AI Models", new JsonArray().add("CNN").add("ResNet"))
                .put("Potential Benefits", new JsonArray().add("Reduced crop loss").add("Early diagnosis")));
    ...
    void createDXAIModelItemEntity() {
        ...
        JsonObject jsonPayload = new JsonObject()
            ...
            .put("shortDescription", "Short description of the AI model")
            .put("industry", "Agriculture")
            .put("uploadedBy", "provider@example.com")
            .put("license", "MIT")
            .put("fileSize", "5MB");
        Response response = given()
            .contentType("application/json")
    ...
    void createDXDataBankResourceItemEntity() {
        ...
        JsonObject jsonPayload = new JsonObject()
            ...
            .put("location", new JsonObject()
                .put("type", "Place")
                .put("address", "Khammam, Telanagana")
                .put("geometry", new JsonObject()
                    .put("type", "Polygon")
                    .put("coordinates", new JsonArray().add(
                        new JsonArray()
                            .add(new JsonArray().add(77.570423).add(13.013945))
                            .add(new JsonArray().add(77.571000).add(13.014500))
                            .add(new JsonArray().add(77.572000).add(13.013500))
                            .add(new JsonArray().add(77.570423).add(13.013945))
                    ))
                ))
            .put("dataDescriptor", new JsonObject()
                .put("type", new JsonArray().add("DataSchema"))
                .put("dataDescriptorLabel", "Observation data schema")
                .put("description", "Schema for daily observations")
                .put("precipitation", new JsonObject()
                    .put("type", new JsonArray().add("QuantitativeValue"))
                    .put("description", "Rainfall in mm")
                    .put("unitCode", "MMT")
                    .put("unitText", "Millimetre")
                    .put("dataSchema", "number"))
                .put("airTemperature", new JsonObject()
                    .put("type", new JsonArray().add("QuantitativeValue"))
                    .put("description", "Daily air temperature readings")
                    .put("maxOverTime", new JsonObject()
                        .put("type", new JsonArray().add("QuantitativeValue"))
                        .put("description", "Max temperature")
                        .put("unitCode", "CEL")
                        .put("unitText", "Celsius")
                        .put("dataSchema", "number"))
                    .put("minOverTime", new JsonObject()
                        .put("type", new JsonArray().add("QuantitativeValue"))
                        .put("description", "Min temperature")
                        .put("unitCode", "CEL")
                        .put("unitText", "Celsius")
                        .put("dataSchema", "number")))
                .put("observationDateTime", new JsonObject()
                    .put("type", new JsonArray().add("DateTime"))
                    .put("description", "Timestamp of the observation")
                    .put("dataSchema", "date-time")))
            .put("dataSample", new JsonObject()
                .put("precipitation", 12.3)
                .put("airTemperature", new JsonObject()
                    .put("maxOverTime", 34.5)
                    .put("minOverTime", 22.0))
                .put("observationDateTime", "2024-07-20T06:00:00Z"))
            .put("fileFormat", "xlsx")
            .put("shortDescription", "short description for the data bank item")
            .put("industry",  "Agriculture")
            .put("uploadedBy", "admin@datakaveri.org")
            .put("geoCoverage", "Pan India")
            .put("yearRange", "2010-2023")
            .put( "verifiedBy", "CDPG Quality Team")
            .put("uploadFrequency", "Weekly")
            .put("license", "CDPG Standard License");
        Response response = given()
            .contentType("application/json")
            .header("token", token)
            .body(jsonPayload.toString())
