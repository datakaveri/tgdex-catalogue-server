...
public class AccessPolicyQueryDecoratorNew implements ElasticsearchQueryDecorator {
  private static final Logger LOGGER = LogManager.getLogger(AccessPolicyQueryDecoratorNew.class);
  private final Map<FilterType, List<QueryModel>> queryMap;
  private final AccessPolicyRequestDTO request;

  public AccessPolicyQueryDecoratorNew(
